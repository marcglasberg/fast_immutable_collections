...
class MutableListAddAllBenchmark extends ListBenchmarkBase {
  ...
  @override
  void setup() => fixedList = List<int>.of(ListAddAllBenchmark.baseList);

  @override
  void run() {
    list = List<int>.of(fixedList);
    list.addAll(ListAddAllBenchmark.listToAdd);
  }
}
...
class IListAddAllBenchmark extends ListBenchmarkBase {
  ...
  @override
  void setup() => iList = IList<int>(ListAddAllBenchmark.baseList);

  @override
  void run() => result = iList.addAll(ListAddAllBenchmark.listToAdd);
}
...
class KtListAddAllBenchmark extends ListBenchmarkBase {
  ...
  @override
  void setup() => ktList = KtList<int>.from(ListAddAllBenchmark.baseList);

  /// If the added list were already of type `KtList`, then it would be much faster.
  @override
  void run() => result = ktList.plus(KtList<int>.from(ListAddAllBenchmark.listToAdd));
}
...
class BuiltListAddAllBenchmark extends ListBenchmarkBase {
  ...
  @override
  void setup() => builtList = BuiltList<int>.of(ListAddAllBenchmark.baseList);
