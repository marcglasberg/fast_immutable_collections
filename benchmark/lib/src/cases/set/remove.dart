...
class ISetRemoveBenchmark extends SetBenchmarkBase {
  ...
  @override
  void setup() => _fixedSet =
      ISet(SetBenchmarkBase.getDummyGeneratedSet(size: config.size));
...
class KtSetRemoveBenchmark extends SetBenchmarkBase {
  ...
  @override
  void setup() => _fixedSet =
      KtSet.from(SetBenchmarkBase.getDummyGeneratedSet(size: config.size));
...
class BuiltSetRemoveBenchmark extends SetBenchmarkBase {
  ...
  @override
  void setup() => _fixedSet =
      BuiltSet.of(SetBenchmarkBase.getDummyGeneratedSet(size: config.size));

  @override
  void run() => _builtSet =
      _fixedSet.rebuild((SetBuilder<int> setBuilder) => setBuilder.remove(1));
}
