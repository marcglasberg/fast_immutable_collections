...
abstract class IList<T> // ignore: must_be_immutable
  ...
  /// Returns an [Iterable] containing successive accumulation values generated by applying
  /// [combine] from left to right to each element and current accumulator value that starts with [initialValue].
  Iterable<E> scan<E>(E initialValue, E Function(E previousValue, T element) combine) =>
      _l.scan(initialValue, combine);
...
abstract class L<T> implements Iterable<T> {
  ...
  /// [combine] from left to right to each element and current accumulator value that starts with [initialValue].
  L<E> scan<E>(E initialValue, E Function(E previousValue, T element) combine) {
