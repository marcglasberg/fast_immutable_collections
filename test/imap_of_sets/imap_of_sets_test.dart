...
//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  group("Testing the remaining methods |", () {
    ...
    group("IMapOfSets.withValue family |", () {
      ...
      test("IMapOfSets.entryWithValue method", () {
        expect(iMapOfSets.getEntryWithValue(1).asEntry,
            Entry("a", ISet<int>({1, 2})));
        expect(iMapOfSets.getEntryWithValue(2).asEntry,
            Entry("a", ISet<int>({1, 2})));
        expect(iMapOfSets.getEntryWithValue(3).asEntry,
            Entry("b", ISet<int>({3})));
      ...
      test("IMapOfSets.allEntriesWithValue method", () {
        ...
        expect(iMapOfSets.allEntriesWithValue(2).toString(),
            "{MapEntry(a: {1, 2})}");
        expect(
            iMapOfSets.allEntriesWithValue(3).toString(), "{MapEntry(b: {3})}");
      });
    ...
    test("IMapOfSets.toString method",
  ...
  group("Other Methods |", () {
    ...
    test(
        "IMapOfSets.forEach method",
        () => iMapOfSets.forEach(
            (String key, ISet<int> set) => expect(iMapOfSets[key], set)));
    ...
    test("IMapOfSets.removeWhere method", () {
      final IMapOfSets<String, int> newIMapOfSets = iMapOfSets
          .removeWhere((String key, ISet<int> set) => set.contains(10));
