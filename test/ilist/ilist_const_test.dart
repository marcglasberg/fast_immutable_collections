...
void main() {
  ...
  test("hashCode", () {
    ...
    // // 1) Simple usage
    // IList<int> ilist = IListConst([1, 2]);
    // expect(ilist == ilist, isTrue);
    // expect(ilist == IListConst([1, 2]), isTrue);
    // expect(ilist == IListConst([1]), isFalse);
    // expect(ilist == IListConst(([2, 1])), isFalse);
    // expect(ilist == IListConst([1, 2]).withIdentityEquals, isFalse);
    // expect(ilist == IListConst<int>([]), isFalse);
    // expect(ilist == IListConst<int?>([null]), isFalse);
    // expect(ilist == IListConst<int>([1]), isFalse);
    // expect(ilist == IListConst<int?>([null, null, null]), isFalse);
    //
    // // 2) identity-equals compares the list instance, not the items
    // ilist = IListConst([1, 2]).withIdentityEquals;
    // expect(ilist == ilist, isTrue);
    // expect(ilist == IListConst([1, 2]).withIdentityEquals, isFalse);
    // expect(ilist == IListConst([2, 1]).withIdentityEquals, isFalse);
    // expect(ilist == [1, 2].lock, isFalse);
    // expect(ilist == IListConst([1, 2, 3]).withIdentityEquals, isFalse);
    // expect(ilist == IListConst<int>([]), isFalse);
    // expect(ilist == IListConst<int?>([null]), isFalse);
    // expect(ilist == IListConst<int>([1]), isFalse);
    // expect(ilist == IListConst<int?>([null, null, null]), isFalse);
    // expect(ilist == IListConst<int?>([null, 1, null, 2]), isFalse);
    //
    // // 3) deep-equals compares the items, not necessarily the list instance
    // ilist = IListConst([1, 2]);
    // expect(ilist == IListConst([1, 2]), isTrue);
    // expect(ilist == IListConst([2, 1]), isFalse);
    // expect(ilist == [1, 2].lock.withDeepEquals, isTrue);
    // expect(ilist == IListConst([1, 2, 3]), isFalse);
    // expect(ilist == IListConst<int>([]), isFalse);
    // expect(ilist == IListConst<int?>([null]), isFalse);
    // expect(ilist == IListConst<int>([1]), isFalse);
    // expect(ilist == IListConst<int?>([null, null, null]), isFalse);
    ...
    // ilist = IListConst<int>([]);
    // expect(ilist == IListConst<int>([]), isTrue);
    // expect(ilist == IListConst<int?>([null]), isFalse);
    // expect(ilist == IListConst<int>([1]), isFalse);
    // expect(ilist == IListConst<int?>([null, null, null]), isFalse);
    // expect(ilist == IListConst<int?>([null, 1, null, 2]), isFalse);
    //
    // ilist = IListConst<int?>([null]);
    // expect(ilist == IListConst<int>([]), isFalse);
    // expect(ilist == IListConst<int?>([null]), isTrue);
    // expect(ilist == IListConst<int>([1]), isFalse);
    // expect(ilist == IListConst<int?>([null, null, null]), isFalse);
    // expect(ilist == IListConst<int?>([null, 1, null, 2]), isFalse);
    //
    // ilist = IListConst<int>([1]);
    // expect(ilist == IListConst<int>([]), isFalse);
    // expect(ilist == IListConst<int?>([null]), isFalse);
    // expect(ilist == IListConst<int>([1]), isTrue);
    // expect(ilist == IListConst<int?>([null, null, null]), isFalse);
    // expect(ilist == IListConst<int?>([null, 1, null, 2]), isFalse);
    //
    // ilist = IListConst<int?>([null, null, null]);
    // expect(ilist == IListConst<int>([]), isFalse);
    // expect(ilist == IListConst<int?>([null]), isFalse);
    // expect(ilist == IListConst<int>([1]), isFalse);
    // expect(ilist == IListConst<int?>([null, null, null]), isTrue);
    // expect(ilist == IListConst<int?>([null, 1, null, 2]), isFalse);
    //
    // ilist = IListConst<int?>([null, 1, null, 2]);
    // expect(ilist == IListConst<int>([]), isFalse);
    // expect(ilist == IListConst<int?>([null]), isFalse);
    // expect(ilist == IListConst<int>([1]), isFalse);
    // expect(ilist == IListConst<int?>([null, null, null]), isFalse);
    // expect(ilist == IListConst<int?>([null, 1, null, 2]), isTrue);
  });
  ...
  // test("same", () {
  //   // 1) Regular usage
  //   IListConst<int?> ilist = IListConst([1, 2]);
  //   expect(ilist.same(ilist), isTrue);
  //   expect(ilist.same(IListConst([1, 2])), isFalse);
  //   expect(ilist.same(IListConst([1])), isFalse);
  //   expect(ilist.same(IListConst(([2, 1]))), isFalse);
  //   expect(ilist.same(IListConst([1, 2]).withIdentityEquals), isFalse);
  //   expect(ilist.same(IListConst([1, 2]).withConfig(ConfigList(cacheHashCode: false))), isFalse);
  //   expect(ilist.same(ilist.remove(3)), isTrue);
  //   expect(ilist.same(IListConst<int>([])), isFalse);
  //   expect(ilist.same(IListConst<int?>([null])), isFalse);
  //   expect(ilist.same(IListConst<int>([1])), isFalse);
  //   expect(ilist.same(IListConst<int?>([null, null, null])), isFalse);
  //   expect(ilist.same(IListConst<int?>([null, 1, null, 2])), isFalse);
  //
  ...
  //   final IListConst<int> ilist = IListConst([1, 2]);
  //   expect(ilist.equalItemsAndConfig(ilist), isTrue);
  //   expect(ilist.equalItemsAndConfig(IListConst([1, 2])), isTrue);
  //   expect(ilist.equalItemsAndConfig(IListConst([1])), isFalse);
  //   expect(ilist.equalItemsAndConfig(IListConst(([2, 1]))), isFalse);
  //   expect(ilist.equalItemsAndConfig(IListConst([1, 2]).withIdentityEquals), isFalse);
  ...
  //
  //   // 3) If IListConst, will only be equal if in order and the same items
  //   expect(ilist.equalItems(IListConst([2, 1])), isFalse);
  //   expect(ilist.equalItems(IListConst([1, 2])), isTrue);
  //
  //   // 4) Other Checks
  //   expect(ilist.equalItems(IListConst([1])), isFalse);
  //   expect(ilist.equalItems(IListConst([1, 2, 3])), isFalse);
  //   expect(ilist.equalItems(IListConst([])), isFalse);
  //
  ...
  //   expect(ilist.unorderedEqualItems(IListConst([1])), isFalse);
  //   expect(ilist.unorderedEqualItems(IListConst([2, 1])), isTrue);
  //   expect(ilist.unorderedEqualItems(ilist), isTrue);
  ...
  //   expect(ilist == IListConst([1, 2, 3]), isFalse);
  //   expect(ilist == IListConst([2, 1]), isFalse);
  //   expect(ilist.hashCode, IListConst([1, 2]).hashCode);
  //   expect(ilist.hashCode, isNot(IListConst([1, 2, 3]).hashCode));
  //   expect(ilist.hashCode, isNot(IListConst([2, 1]).hashCode));
  //
  //   // 2) identityEquals vs identityEquals
  //   final IListConst<int> iListWithIdentityEquals = IListConst([1, 2]).withIdentityEquals;
  //   expect(iListWithIdentityEquals == IListConst([1, 2]).withIdentityEquals, isFalse);
  //   expect(iListWithIdentityEquals == IListConst([1, 2, 3]).withIdentityEquals, isFalse);
  //   expect(iListWithIdentityEquals == IListConst([2, 1]).withIdentityEquals, isFalse);
  //   expect(iListWithIdentityEquals.hashCode, isNot(IListConst([1, 2]).withIdentityEquals.hashCode));
  //   expect(iListWithIdentityEquals.hashCode, isNot(IListConst([1, 2, 3]).withIdentityEquals.hashCode));
  //   expect(iListWithIdentityEquals.hashCode, isNot(IListConst([2, 1]).withIdentityEquals.hashCode));
  //
  //   // 3) deepEquals vs identityEquals
  //   expect(IListConst([1, 2]) == IListConst([1, 2]).withIdentityEquals, isFalse);
  //   expect(IListConst([1, 2]) == IListConst([1, 2]).withIdentityEquals, isFalse);
  //   expect(IListConst([1, 2, 3]) == IListConst([1, 2, 3]).withIdentityEquals, isFalse);
  //   expect(IListConst([2, 1]) == IListConst([2, 1]).withIdentityEquals, isFalse);
  //   expect(IListConst([1, 2]).hashCode, isNot(IListConst([1, 2]).withIdentityEquals.hashCode));
  //   expect(IListConst([1, 2]).hashCode, isNot(IListConst([1, 2]).withIdentityEquals.hashCode));
  //   expect(IListConst([1, 2, 3]).hashCode, isNot(IListConst([1, 2, 3]).withIdentityEquals.hashCode));
  //   expect(IListConst([2, 1]).hashCode, isNot(IListConst([2, 1]).withIdentityEquals.hashCode));
  //
  //   // 4) When cache is on
  //   List<int> list = [1, 2, 3];
  //
  //   final IListConst<int> iListWithCache = IListConst.unsafe(list, config: ConfigList(cacheHashCode: true));
  //
  ...
  //   list = [1, 2, 3];
  //
  //   final IListConst<int> iListWithoutCache =
  //       IListConst.unsafe(list, config: ConfigList(cacheHashCode: false));
  //
  ...
  //   expect(ilist.isDeepEquals, isTrue);
  //
  //   IListConst<int> iListNewConfig = ilist.withConfig(ilist.config.copyWith());
  //
  //   IListConst<int> iListNewConfigIdentity =
  ...
  //   final IListConst<int> emptyIList = <int>[].lock;
  //   expect(IListConst.withConfig(emptyIList, const ConfigList(cacheHashCode: false)), []);
  //
  //   // 3) With non-empty list and different configs
  //   final IListConst<int> nonemptyIList = <int>[1, 2, 3].lock;
  //   expect(IListConst.withConfig(nonemptyIList, const ConfigList(cacheHashCode: false)), [1, 2, 3]);
  // });
  //
  // //////////////////////////////////////////////////////////////////////////////
  //
  ...
  //   expect(ilist.isDeepEquals, isTrue);
  //
  //   final IListConst<int> iListWithNoDeepEquals = ilist.withConfig(ConfigList(isDeepEquals: false));
  //
  //   expect(iListWithNoDeepEquals.isDeepEquals, isFalse);
  //
  //   final IListConst<int> iListWithConfig = ilist.withConfigFrom(iListWithNoDeepEquals);
  //
  ...
  //   expect(IListConst([1, 2, 3]).unlock, [1, 2, 3]);
  //   expect(identical(IListConst([1, 2, 3]).unlock, [1, 2, 3]), isFalse);
  // });
  //
  // //////////////////////////////////////////////////////////////////////////////
  //
  ...
  //
  // test("fromISet", () {
  //   expect(IListConst.fromISet({1, 2, 3}.lock, config: null), [1, 2, 3]);
  // });
  //
  // //////////////////////////////////////////////////////////////////////////////
  //
  ...
  //   // 1) Null -> Null
  //   Iterable<int>? iter;
  //   expect(IListConst.orNull(iter), isNull);
  //
  //   // 2) Iterable -> IListConst
  //   iter = [1, 2, 3];
  //   expect(IListConst.orNull(iter), allOf(isA<IListConst<int>>(), [1, 2, 3]));
  //
  //   // 3) Iterable with Config -> IListConst with Config
  //   IListConst<int>? ilist = IListConst.orNull(iter, ConfigList(isDeepEquals: false));
  //   expect(ilist, [1, 2, 3]);
  ...
  //   final IListConst<int> ilist = IListConst.unsafe(list, config: ConfigList());
  //
  //   expect(list, [1, 2, 3]);
  //   expect(ilist, [1, 2, 3]);
  //
  ...
  //   expect(() => IListConst.unsafe([1, 2, 3], config: ConfigList()), throwsUnsupportedError);
  // });
  //
  // //////////////////////////////////////////////////////////////////////////////
  //
  // test("flush", () {
  //   final IListConst<int> ilist = [1, 2, 3].lock.add(4).addAll([5, 6]).add(7).addAll([]).addAll([8, 9]);
  //
  ...
  //   IListConst<int> ilist = [1, 2, 1, 3].lock;
  //
  //   IListConst<int> updatedIList = ilist.updateById([3, 10], (int item) => item * 10);
  //
  ...
  // test("remove", () {
  //   // 1) Regular Usage
  //   final IListConst<int> ilist1 = [1, 2, 3].lock;
  //
  //   final IListConst<int> ilist2 = ilist1.remove(2);
  //   expect(ilist2.unlock, [1, 3]);
  //
  //   final IListConst<int> ilist3 = ilist2.remove(5);
  //   expect(ilist3.unlock, [1, 3]);
  //
  //   final IListConst<int> ilist4 = ilist3.remove(1);
  //   expect(ilist4.unlock, [3]);
  //
  //   final IListConst<int> ilist5 = ilist4.remove(3);
  //   expect(ilist5.unlock, []);
  //
  //   final IListConst<int> ilist6 = ilist5.remove(7);
  ...
  //
  // test("maxLength", () {
  //   final IListConst<int> ilist1 = [1, 2, 3, 4, 5].lock;
  //   final IListConst<int> ilist2 = [5, 3, 5, 8, 12, 18, 32, 2, 1, 9].lock;
  //
  //   // 1) Regular Usage
  ...
  //
  // test("toggle", () {
  //   IListConst<int> ilist = [1, 2, 3, 4, 5].lock;
  //
  ...
  //
  // test("[]", () {
  //   final IListConst<String> ilist = ["a", "b", "c"].lock;
  //   expect(ilist[0], "a");
  //   expect(ilist[1], "b");
  //   expect(ilist[2], "c");
  ...
  //
  // test("any", () {
  //   final IListConst<int> ilist = [1, 2, 3, 4, 5, 6].lock;
  ...
  //
  // test("inRange", () {
  //   final IListConst<int> ilist = [1, 2, 3].lock;
  ...
  //
  // test("clear", () {
  //   final IListConst<int> ilist = IListConst.withConfig([1, 2, 3], ConfigList(isDeepEquals: false));
  //
  //   final IListConst<int> iListCleared = ilist.clear();
  //
  //   expect(iListCleared, allOf(isA<IListConst<int>>(), []));
  ...
  //
  // test("indexWhere", () {
  //   final IListConst<String> ilist = ["do", "re", "mi", "re"].lock;
  //
  ...
  //   var emptyIlist = IListConst<String>();
  ...
  // test("lastIndexOf", () {
  //   // 1) Regular Usage
  //   IListConst<String> ilist = ["do", "re", "mi", "re"].lock;
  ...
  //
  // test("getRange", () {
  //   final IListConst<String> colors = ["red", "green", "blue", "orange", "pink"].lock;
  ...
  //
  // test("put", () {
  //   final IListConst<int> ilist = [1, 2, 4, 5].lock;
  //
  //   final IListConst<int?> completeIList = ilist.put(2, 3);
  //
  ...
  //   int testCount = 0;
  //   int convertCount = 0;
  //   var converted = original.process(test: (IListConst<String?> ilist, int index, String? item) {
  //     testCount++;
  //     expect(identical(item, ilist[index]), isTrue);
  //     return true;
  //   }, convert: (IListConst<String?> ilist, int index, String? item) {
  //     convertCount++;
  //     expect(identical(item, ilist[index]), isTrue);
  //     return ["x"];
  //   });
  ...
  //
  // test("retainWhere", () {
  //   final IListConst<String> numbers = ["one", "two", "three", "four"].lock;
  ...
  //
  // test("shuffle", () {
  //   final IListConst<int> ilist = [1, 2, 3, 4, 5, 6, 7, 8, 9].lock;
  ...
  //   final IListConst<int> numbs = [1, 5, 20, 21, 19, 16, 54, 50, 23, 55, 18, 20, 15].lock;
  //
  ...
  // test("flushFactor", () {
  //   // 1) Default value
  //   expect(IListConst.flushFactor, 300);
  //
  //   // 2) Setter
  //   IListConst.flushFactor = 100;
  //   expect(IListConst.flushFactor, 100);
  //
  //   // 3) Can't be smaller than or equal to 0
  //   expect(() => IListConst.flushFactor = 0, throwsStateError);
  //   expect(() => IListConst.flushFactor = -100, throwsStateError);
  // });
  //
  // //////////////////////////////////////////////////////////////////////////////
  //
  // test("asyncAutoFlush", () {
  //   expect(IListConst.asyncAutoflush, isTrue);
  // });
  //
  // //////////////////////////////////////////////////////////////////////////////
  //
  ...
  //   // -------------
  //
  //   // 2) IListConst methods that return an Iterable do lazy processing.
  //
  //   int count2 = 0;
  //
