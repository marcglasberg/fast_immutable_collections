...
void main() {
  ...
  test("IListConst", () {
    // 1) empty
    const ilist1 = IListConst.empty();

    print(ilist1.hashCode);

    expect(ilist1.add(1), [1]);

    // 2) non-empty
    const ilist2 = IListConst([1, 2, 3]);

    print(ilist2.hashCode);

    expect(ilist2, [1, 2, 3]);
    expect(ilist2.add(4), [1, 2, 3, 4]);
  });
  ...
  test("IListConst", () {
    //
    // The .empty() constructor will always use the same const [] internals.
    expect(const IListConst.empty().same(const IListConst.empty()), isTrue);
    expect(const IListConst.empty().same(IListConst.empty()), isTrue);
    expect(const IListConst.empty().same(const IListConst.empty()), isTrue);
    expect(IListConst.empty().same(IListConst.empty()), isTrue);
    ...
    // Both IListConst are const. So they are the same.
    expect(
        const IListConst([1, 2, 3]).same(const IListConst([1, 2, 3])), isTrue);
  ...
  test("Interaction between IList and IListConst", () {
    //
    // Empty.
    expect(IListConst.empty().same(IList()), isFalse);
    expect(IListConst.empty().same(IList.empty()), isFalse);
    expect(IList().same(IListConst([])), isFalse);
    expect(IList().same(IListConst.empty()), isFalse);
    expect(IList.empty().same(IListConst.empty()), isFalse);
    expect(IList.empty().same(IListConst([])), isFalse);
    expect(const IListConst.empty().same(IList()), isFalse);
    expect(const IListConst.empty().same(IList.empty()), isFalse);
    expect(IList().same(const IListConst([])), isFalse);
    expect(IList().same(const IListConst.empty()), isFalse);
    expect(IList.empty().same(const IListConst.empty()), isFalse);
    expect(IList.empty().same(const IListConst([])), isFalse);
    ...
    expect(IList.empty().equalItems(const IListConst.empty()), isTrue);
    expect(IList.empty().equalItems(IListConst.empty()), isTrue);
    ...
    expect(IList.empty().equalItemsAndConfig(const IListConst.empty()), isTrue);
    expect(IList.empty().equalItemsAndConfig(IListConst.empty()), isTrue);
    ...
    expect(IList.empty().unorderedEqualItems(const IListConst.empty()), isTrue);
    expect(IList.empty().unorderedEqualItems(IListConst.empty()), isTrue);
